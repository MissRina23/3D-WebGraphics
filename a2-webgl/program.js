...
define([], function() {
     ...
     *
     */
    // console.log('executing module program.js');
    ...
    */
    ...
    proto.glRenderContext = function() {
        return this.gl;
    };

    /* method: return WebGL program object */
    proto.glProgramObject = function() {
    ...
    */
    proto.setUniform = function(name, type, value, showWarning) {
        ...
        if (location == null && showWarning) {
            console.log('WARNING: uniform variable ' + name + ' not used in shader.');
        }
        else {
            switch (type) {
                case 'mat4' : this.gl.uniformMatrix4fv(location, false, value); return true;
                case 'mat3' : this.gl.uniformMatrix3fv(location, false, value); return true;
                case 'mat2' : this.gl.uniformMatrix2fv(location, false, value); return true;
                case 'vec4' : this.gl.uniform4fv(location, value); return true;
                case 'vec3' : this.gl.uniform3fv(location, value); return true;
                case 'vec2' : this.gl.uniform2fv(location, value); return true;
                case 'float': this.gl.uniform1f(location, value); return true;
                case 'int'  : this.gl.uniform1i(location, value); return true;
                // bool is transferred as integer!
                case 'bool' : this.gl.uniform1i(location, value); return true;
                default:
    ...
    */
    proto.setTexture = function(uniformName, textureUnit, texture, showWarning) {
        ...
        if (!texture.isLoaded) {
            console.log('info: image file for texture '+ uniformName +' not loaded yet.');
            return false;
        }
        ...
        // console.log('using texture unit '+textureUnit+' for sampler '+samplerName);
